...
// @section lcd
  ...
  #define TEMP_CALIBRATION_FEEDRATE            1
  
  #define MANUAL_FEEDRATE {50*60, 50*60, 4*60, TEMP_CALIBRATION_FEEDRATE} // Feedrates for manual moves along X, Y, Z, E from panel
...
//#define LED_CONTROL_MENU
   ...
   * point in the file.
   */
  //#define POWER_LOSS_RECOVERY //JDK ?? does this work for our machines?
 ...
 */
  ...
  #define FILAMENT_Z_LIFT_LENGTH              37  // (mm) Lift from Bed to see extrusion.
  #define FILAMENT_X_MOVE_LENGTH              X_CENTER  // (mm) Lift from Bed to see extrusion.
  #define FILAMENT_Y_MOVE_LENGTH              37  // (mm) Lift from Bed to see extrusion.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH          20 // (mm) Length to extrude after loading.
                                                  ...
                                                  //	Filament can be extruded repeatedly from the Filament Change
  ...
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change. off for safety.

  #define PARK_HEAD_ON_PAUSE     //JDK beta       // Park the nozzle during pause and filament change.
...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_GCODE_2 "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_220_TEMP_HOTEND)

  #define USER_DESC_3 "Preheat for ABS"
  #define USER_GCODE_3 "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_235_TEMP_HOTEND)
 ...
 */
  ...
  #define I2CPE_ENC_1_EC_THRESH     0.70                    // Threshold size for error (in mm) above which the
  ...
  #define I2CPE_ENC_2_INVERT        true
  #define I2CPE_ENC_2_EC_METHOD     I2CPE_ECM_MICROSTEP
  #define I2CPE_ENC_2_EC_THRESH     0.70
