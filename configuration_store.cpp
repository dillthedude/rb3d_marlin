...
void MarlinSettings::postprocess() {
  ...
  bool MarlinSettings::save() {
    ...
    _FIELD_TEST(lcd_preheat_hotend_temp);
      ...
      constexpr int16_t lcd_preheat_hotend_temp[2] = { PREHEAT_220_TEMP_HOTEND, PREHEAT_235_TEMP_HOTEND },
...
void MarlinSettings::reset() {
  ...
  //
    ...
    lcd_preheat_hotend_temp[0] = PREHEAT_220_TEMP_HOTEND;
    lcd_preheat_hotend_temp[1] = PREHEAT_235_TEMP_HOTEND;
    lcd_preheat_bed_temp[0] = PREHEAT_60_TEMP_BED;
    lcd_preheat_bed_temp[1] = PREHEAT_100_TEMP_BED;
    lcd_preheat_fan_speed[0] = PREHEAT_0_FAN_SPEED;
    lcd_preheat_fan_speed[1] = PREHEAT_0_FAN_SPEED;
  #endif
